...
public class RandomUtils {
	...
	private static String[] firstname = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈",
			...
			"墨", "哈", "谯", "笪", "年", "爱", "阳", "佟" };
	private static String[] lastname = { "伟", "伟", "芳", "伟", "秀英", "秀英", "娜", "秀英", "伟",
	...
	private static char[] letter = "ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz0123456789".toCharArray();
	/**
	 * 生成随机数字字符串
	 * @param len
	 * @return
	...
	public static String createRandomNumber(int len) {
		...
		int index = (int)Math.floor(Math.random()*9) + 1; 
