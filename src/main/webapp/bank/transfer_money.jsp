...
<body>
	...
	<div class="sidebar-nav">
		...
		<ul id="dashboard-menu" class="nav nav-list collapse in">
			...
			<li><a href="javascript:void(0);">转账</a>
			</li>
		</ul>
		...
		<div class="save_money" style="margin-top:50px;margin-left:200px;">
			...
			<form class="form-horizontal" role="form" id="myform">
				<div class="form-group" style="margin-top:10px;">
					<label for="sendAccount" class="col-sm-2 control-label"><strong>转账人账号:</strong>&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="sendAccount"
							placeholder="请输入转账人卡号" name="sendAccount" oninput="check_account(true,this)"><lable id = "ck_saccount"></lable>
					</div>
				</div>
				<div class="form-group" style="margin-top:30px;">
					<label for="password" class="col-sm-2 control-label"><strong>转账人密码:</strong>&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<div class="col-sm-5">
						<input type="password" class="form-control" id="password"
							placeholder="请输入转账卡密码" name="password" oninput="check_password(true)"><lable id = "ck_password"></lable>
					</div>
				</div>
				<div class="form-group" style="margin-top:30px;">
					<label for="recAccount" class="col-sm-2 control-label"><strong>收款人账号:</strong>&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="recAccount"
							placeholder="请输入收款人账号" name="recAccount" oninput="check_account(true,this)"><lable id = "ck_raccount"></lable>
					</div>
				</div>
				<div class="form-group" style="margin-top:30px;">
					<label for="money" class="col-sm-2 control-label"><strong>转账金额(元):</strong>&nbsp;&nbsp;&nbsp;&nbsp;</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="money"
							placeholder="请输入转账金额" oninput="check_money()" name="money"><lable id = "ck_money"></lable>
					</div>
				</div>
...
<script type="text/javascript">
	var isSendAccountOK = false;
	var isRecAccountOK = false;
	...
	//校验输入的账号是否存在,因为有两个账号，参数obj判断传入的是哪一个账号
	function check_account(isAsync,obj) {
		//alert(isAsync);
		//alert(obj.name);
		if(obj.name == "recAccount") {
			
			if(obj.value == document.getElementById("sendAccount").value) {
			   
			   document.getElementById("ck_raccount").innerHTML="&nbsp;&nbsp;&nbsp;收款人不能为自己!";
     		   document.getElementById("ck_raccount").style.color="red";
     		   document.getElementById("ck_raccount").style.fontWeight="bold";//设置字体加粗
     		   isRecAccountOK = false;
     		   return false;
			}
		}
		//请求账户名是否存在
		var acc = {"account":obj.value};
		$.ajax({  
            type: "GET",  
            ...
            success: function(data) {
               ...
               if(data.msg == "ok") {
            	   ...
            	   if(obj.name == "sendAccount") {
            		   document.getElementById("ck_saccount").innerHTML="";
            		   isSendAccountOK = true;
            	   } else {
            		   document.getElementById("ck_raccount").innerHTML="";
            		   isRecAccountOK = true;
            	   }
            	   ...
            	   if(obj.name == "sendAccount") {
            		   document.getElementById("ck_saccount").innerHTML="&nbsp;&nbsp;&nbsp;账户不存在!";
            		   document.getElementById("ck_saccount").style.color="red";
            		   document.getElementById("ck_saccount").style.fontWeight="bold";//设置字体加粗
          			   isSendAccountOK = false;
            	   } else {
            		   document.getElementById("ck_raccount").innerHTML="&nbsp;&nbsp;&nbsp;账户不存在!";
            		   document.getElementById("ck_raccount").style.color="red";
            		   document.getElementById("ck_raccount").style.fontWeight="bold";//设置字体加粗
            		   isRecAccountOK = false;
            	   }
	...
	function check_password(isAsync) {
		...
		var input_account = document.getElementById("sendAccount");
	...
	function save() {
		...
		if(!isPasswordOK || !isSendAccountOK || !isRecAccountOK) return ;
		//alert($('#myform').serialize());
		$.ajax({  
            type: "POST",  
            url:"transfer_money.do",  
